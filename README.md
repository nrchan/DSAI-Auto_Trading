...
| Window Size | Test 1 | Test 2 | Test 3 | Test 4 | Test 5 | 平均 |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 1 | -5.46 | -4.06 | -5.54 | -5.54 | -5.54 | -5.22 |
| 2 | 1.36  | 1.84  | 1.36  | 0.68  | 1.84  | 1.41  |
| 3 | -0.4  | -1.43 | 0.56  | 0.56  | -0.4  | -0.22 |

整體看起來，好像都不要做動作是最保險的。特別是 testing data 的影響應該也很大。

不過還是賭一下好了，最後選了 window size = 2。